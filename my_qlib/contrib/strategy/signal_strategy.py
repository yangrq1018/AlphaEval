...
from my_qlib.data.dataset import Dataset
from my_qlib.model.base import BaseModel
from my_qlib.strategy.base import BaseStrategy
from my_qlib.backtest.position import Position
from my_qlib.backtest.signal import Signal, create_signal_from
from my_qlib.backtest.decision import Order, OrderDir, TradeDecisionWO
from my_qlib.log import get_module_logger
from my_qlib.utils import get_pre_trading_date, load_dataset
from my_qlib.contrib.strategy.order_generator import OrderGenerator, OrderGenWOInteract
from my_qlib.contrib.strategy.optimizer import EnhancedIndexingOptimizer
...
class BaseSignalStrategy(BaseStrategy, ABC):
    def __init__(
        ...
        **kwargs,
        ...
        -----------
        signal :
            the information to describe a signal. Please refer to the docs of `my_qlib.backtest.signal.create_signal_from`
        ...
        # This is trying to be compatible with previous version of my_qlib task config
...
class EnhancedIndexingStrategy(WeightStrategyBase):
    ...
    `my_qlib.model.riskmodel.structured.StructuredCovEstimator` to prepare these data.
