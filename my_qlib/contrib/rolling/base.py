...
from my_qlib.model.ens.ensemble import RollingEnsemble
from my_qlib.model.trainer import TrainerR
from my_qlib.utils import get_cls_kwargs, init_instance_by_config
from my_qlib.utils.data import update_config
from my_qlib.workflow import R
from my_qlib.workflow.record_temp import SignalRecord
from my_qlib.workflow.task.collect import RecorderCollector
    ...
    **NOTE**
    ...
    def get_task_list(self) -> List[dict]:
        ...
        for t in task_l:
            ...
            t["record"] = ["my_qlib.workflow.record_temp.SignalRecord"]
        return task_l
    ...
    def _update_rolling_rec(self):
        ...
        for record in records:
            ...
            r = init_instance_by_config(
                record,
                recorder=rec,
                default_module="my_qlib.workflow.record_temp",
            )
            r.generate()
