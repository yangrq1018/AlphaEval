...
from my_qlib.contrib.meta.data_selection.dataset import InternalData, MetaDatasetDS
from my_qlib.contrib.meta.data_selection.model import MetaModelDS
from my_qlib.data.dataset.handler import DataHandlerLP
from my_qlib.model.meta.task import MetaTask
from my_qlib.model.trainer import TrainerR
from my_qlib.typehint import Literal
from my_qlib.utils import init_instance_by_config
from my_qlib.workflow import R
from my_qlib.workflow.task.utils import replace_task_handler_with_cache
...
LGBM_MODEL = """
class: LGBModel
module_path: my_qlib.contrib.model.gbdt
kwargs:
    loss: mse
...
LINEAR_MODEL = """
class: LinearModel
module_path: my_qlib.contrib.model.linear
kwargs:
    estimator: ridge
    alpha: 0.05
"""
    ...
    **NOTE**
    ...
    def _dump_data_for_proxy_model(self):
        ...
        handler = DataHandlerLP(
            data_loader={
                "class": "my_qlib.data.dataset.loader.StaticDataLoader",
    ...
    def _train_meta_model(self, fill_method="max"):
        ...
        proxy_forecast_model_task = {
            # "model": "my_qlib.contrib.model.linear.LinearModel",
            "dataset": {
                "class": "my_qlib.data.dataset.DatasetH",
                "kwargs": {
            ...
            # "record": ["my_qlib.workflow.record_temp.SignalRecord"]
        }
    ...
    def get_task_list(self):
        ...
        # 3) meta model make inference and get new my_qlib task
