...
from my_qlib.contrib.data.dataset import MTSDatasetH
...
class TRAModel(Model):
    ...
    def fit(self, dataset, evals_result=dict()):
        assert isinstance(dataset, MTSDatasetH), "TRAModel only supports `my_qlib.contrib.data.dataset.MTSDatasetH`"
