...
from my_qlib.backtest.position import BasePosition
...
class Exchange:
        ...
        **kwargs: Any,
        ...
        :param volume_threshold: Union[
                                ...
                                1) ("cum" or "current", limit_str) denotes a single volume limit.
                                    - limit_str is my_qlib data expression which is allowed to define your own Operator.
                                    Please refer to my_qlib/contrib/ops/high_freq.py, here are any custom operator for
    ...
    LT_TP_EXP = "(exp)"  # Tuple[str, str]:  the limitation is calculated by a my_qlib expression.
    ...
    def _get_vol_limit(volume_threshold: Union[tuple, dict, None]) -> Tuple[Optional[list], Optional[list], set]:
        ...
        get the fields need to get from my_qlib.
        ...
        -------
        fields: set
            the fields need to get from my_qlib.
