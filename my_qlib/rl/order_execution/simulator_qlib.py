...
from my_qlib.backtest import collect_data_loop, get_strategy_executor
from my_qlib.backtest.decision import BaseTradeDecision, Order, TradeRangeByTime
from my_qlib.backtest.executor import NestedExecutor
from my_qlib.rl.data.integration import init_qlib
from my_qlib.rl.simulator import Simulator
...
class SingleAssetOrderExecution(Simulator[Order, SAOEState, float]):
    """Single-asset order execution (SAOE) simulator which is implemented based on my_qlib backtest tools.
    ...
    qlib_config
        Configuration used to initialize my_qlib. If it is None, my_qlib will not be initialized.
    cash_limit:
        Cash limit.
    """
    ...
    def __init__(
        ...
        strategy_config = {
            ...
            "module_path": "my_qlib.rl.strategy.single_order",
            "kwargs": {
                "order": order,
