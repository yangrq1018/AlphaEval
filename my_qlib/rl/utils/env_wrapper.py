...
from my_qlib.rl.aux_info import AuxiliaryInfoCollector
from my_qlib.rl.interpreter import ActionInterpreter, ObsType, PolicyActType, StateInterpreter
from my_qlib.rl.reward import Reward
from my_qlib.rl.simulator import ActType, InitialStateType, Simulator, StateType
from my_qlib.typehint import TypedDict
...
class EnvWrapper(
    ...
    """my_qlib-based RL environment, subclassing ``gym.Env``.
    ...
    seed_iterator
        An iterable of seed. With the help of :class:`my_qlib.rl.utils.DataQueue`,
