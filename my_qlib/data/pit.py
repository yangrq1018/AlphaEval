...
"""
my_qlib follow the logic below to supporting point-in-time database
...
my_qlib will use the operator `P` to perform the collapse.
"""
import numpy as np
import pandas as pd
from .ops import ElemOperator
