...
from backtest.my_ictester import ICBacktester
...
class _Program(object):
    ...
    def execute(self, X_shape):
        ...
        """
        # print("executing: ", self.program, self.parents)
    ...
    def fitness(self, parsimony_coefficient=None):
        ...
        FITNESS[key] = self.raw_fitness_ - penalty
    ...
    def get_subtree(self, random_state, program=None):
        ...
        probs = np.array([1.0 if isinstance(node, str) and node in functions_arity else 0.0
                          for node in program])
