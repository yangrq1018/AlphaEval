...
from my_qlib.config import C, QlibConfig
...
def complex_parallel(paral: Parallel, complex_iter):
    ...
    >>> from my_qlib.utils.paral import complex_parallel
    >>> from joblib import Parallel, delayed
...
class call_in_subproc:
    ...
    def __init__(self, func: Callable, qlib_config: QlibConfig = None):
        ...
        qlib_config : QlibConfig
            my_qlib config for initialization in subprocess
    ...
    def _func_mod(self, *args, **kwargs):
        """Modify the initial function by adding my_qlib initialization"""
