...
from my_qlib.typehint import InstConf
...
def find_all_classes(module_path: Union[str, ModuleType], cls: type) -> List[type]:
    ...
    - `cls` itself is also included
        ...
        >>> from my_qlib.data.dataset.handler import DataHandler
        >>> find_all_classes("my_qlib.contrib.data.handler", DataHandler)
        [<class 'my_qlib.contrib.data.handler.Alpha158'>, <class 'my_qlib.contrib.data.handler.Alpha158vwap'>, <class 'my_qlib.contrib.data.handler.Alpha360'>, <class 'my_qlib.contrib.data.handler.Alpha360vwap'>, <class 'my_qlib.data.dataset.handler.DataHandlerLP'>]
