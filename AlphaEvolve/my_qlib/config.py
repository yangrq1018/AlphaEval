...
from my_qlib.constant import REG_CN, REG_US, REG_TW

if TYPE_CHECKING:
    from my_qlib.utils.time import Freq
...
_default_config = {
    ...
    # config it in my_qlib.init()
    # "provider_uri" str or dict:
    #   # str
    #   "~/.my_qlib/stock_data/cn_data"
    #   # dict
    #   {"day": "~/.my_qlib/stock_data/cn_data", "1min": "~/.my_qlib/stock_data/cn_data_1min"}
    # NOTE: provider_uri priority:
    #   1. backend_config: backend_obj["kwargs"]["provider_uri"]
    #   2. backend_config: backend_obj["kwargs"]["provider_uri_map"]
    #   3. my_qlib.init: provider_uri
    "provider_uri": "",
    # cache
    ...
    "redis_task_db": 1,
    "redis_password": None,
    # This value can be reset via my_qlib.init
    "logging_level": logging.INFO,
    # Global configuration of my_qlib log
    ...
    "logging_config": {
        ...
        # [1] https://github.com/microsoft/my_qlib/pull/1661
        # [2] https://github.com/pytest-dev/pytest/issues/3697
        "loggers": {"my_qlib": {"level": logging.DEBUG, "handlers": ["console"], "propagate": False}},
        # To let my_qlib work with other packages, we shouldn't disable existing loggers.
    ...
    "exp_manager": {
        ...
        "module_path": "my_qlib.workflow.expm",
        "kwargs": {
...
MODE_CONF = {
    ...
    "client": {
        ...
        "provider_uri": "~/.my_qlib/qlib_data/cn_data",
        # cache
        ...
        # The nfs should be auto-mounted by my_qlib on other
...
HIGH_FREQ_CONFIG = {
    "provider_uri": "~/.my_qlib/qlib_data/cn_data_1min",
    "dataset_cache": None,
...
class QlibConfig(Config):
    ...
    def set(self, default_conf: str = "client", **kwargs):
        """
        configure my_qlib based on the input parameters
    ...
    def register(self):
        ...
        # Supporting user reset my_qlib version (useful when user want to connect to my_qlib server with old version)
        self.reset_qlib_version()

        self._registered = True

    def reset_qlib_version(self):
        import my_qlib  # pylint: disable=C0415

        reset_version = self.get("qlib_reset_version", None)
        if reset_version is not None:
            my_qlib.__version__ = reset_version
        else:
            my_qlib.__version__ = getattr(my_qlib, "__version__bak")
