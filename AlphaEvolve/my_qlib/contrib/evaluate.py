...
def risk_analysis(r, N: int = None, freq: str = "day"):
    ...
    my_qlib tries to cumulated returns by summation instead of production to avoid the cumulated curve being skewed exponentially.
    All the calculation of annualized returns follows this principle in my_qlib.
    ...
    strategy : Union[str, dict, BaseStrategy]
        ...
        .. code-block:: python
            ...
            strategy = {
                ...
                "module_path": "my_qlib.contrib.strategy.signal_strategy",
                "kwargs": {
...
def long_short_backtest(
    ...
    :param extract_codes:  bool.
                       ...
                       NOTE: This will be faster with offline my_qlib.
