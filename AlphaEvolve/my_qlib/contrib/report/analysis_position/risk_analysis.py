    ...
    """Generate analysis graph and monthly analysis
        ...
        Example:
            ...
            .. code-block:: python
                ...
                from my_qlib.utils import flatten_dict
                from my_qlib.backtest import backtest, executor
                from my_qlib.contrib.evaluate import risk_analysis
                from my_qlib.contrib.strategy import TopkDropoutStrategy

                # init my_qlib
                my_qlib.init(provider_uri=<my_qlib data dir>)
