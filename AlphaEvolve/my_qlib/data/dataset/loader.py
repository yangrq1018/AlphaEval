...
from my_qlib.utils import load_dataset, init_instance_by_config, time_to_slc_point
        ...
        dataloader_l : list[dict]
            ...
            .. code-block:: python
                ...
                nd = NestedDataLoader(
                    dataloader_l=[
                        {
                            "class": "my_qlib.contrib.data.loader.Alpha158DL",
                        }, {
                            "class": "my_qlib.contrib.data.loader.Alpha360DL",
                            "kwargs": {
                                "config": {
...
class DataLoaderDH(DataLoader):
    ...
    def __init__(self, handler_config: dict, fetch_kwargs: dict = {}, is_group=False):
        ...
        """
        from my_qlib.data.dataset.handler import DataHandler  # pylint: disable=C0415
