...
``my_qlib`` offer two kinds of Trainer, ``TrainerR`` is the simplest way and ``TrainerRM`` is based on TaskManager to help manager tasks lifecycle automatically.
"""
...
from my_qlib.config import C
from my_qlib.data.dataset import Dataset
from my_qlib.data.dataset.weight import Reweighter
from my_qlib.log import get_module_logger
from my_qlib.model.base import Model
from my_qlib.utils import (
    auto_filter_kwargs,
    fill_placeholder,
    flatten_dict,
    init_instance_by_config,
)
from my_qlib.utils.paral import call_in_subproc
from my_qlib.workflow import R
from my_qlib.workflow.recorder import Recorder
from my_qlib.workflow.task.manage import TaskManager, run_task
