...
from my_qlib.model.ens.group import RollingGroup
from my_qlib.utils import transform_end_date
from my_qlib.workflow.online.utils import OnlineTool, OnlineToolR
from my_qlib.workflow.recorder import Recorder
from my_qlib.workflow.task.collect import Collector, RecorderCollector
...
class OnlineStrategy:
    ...
    def __init__(self, name_id: str):
        """
        Init OnlineStrategy.
        This module **MUST** use `Trainer <../reference/api.html#my_qlib.model.trainer.Trainer>`_ to finishing model training.

        Args:
            name_id (str): a unique name or id.
            trainer (my_qlib.model.trainer.Trainer, optional): a instance of Trainer. Defaults to None.
        """
