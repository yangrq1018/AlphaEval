...
import pandas as pd
from my_qlib import get_module_logger
from my_qlib.data.data import D
from my_qlib.log import set_global_logger_level
from my_qlib.model.ens.ensemble import AverageEnsemble
from my_qlib.model.trainer import Trainer, TrainerR
from my_qlib.utils.serial import Serializable
from my_qlib.workflow.online.strategy import OnlineStrategy
from my_qlib.workflow.task.collect import MergeCollector
...
class OnlineManager(Serializable):
    ...
    def __init__(
        ...
        Args:
            ...
            trainer (my_qlib.model.trainer.Trainer): the trainer to train task. None for using TrainerR.
