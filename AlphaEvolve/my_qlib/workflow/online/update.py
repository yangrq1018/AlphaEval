...
from my_qlib.data.dataset import Dataset, DatasetH, TSDatasetH
from my_qlib.data.dataset.handler import DataHandlerLP
from my_qlib.model import Model
from my_qlib.utils import get_date_by_shift
...
class DSBasedUpdater(RecordUpdater, metaclass=ABCMeta):
    ...
    - Providing updating feature for Updating data based on my_qlib Dataset

    Assumption

    - Based on my_qlib dataset
