...
from my_qlib import auto_init, get_module_logger
...
class TaskManager:
    ...
    python -m my_qlib.workflow.task.manage -h # show manual of manage module CLI
    python -m my_qlib.workflow.task.manage wait -h # show manual of the wait command of manage

    .. code-block:: shell

        python -m my_qlib.workflow.task.manage -t <pool_name> wait
        python -m my_qlib.workflow.task.manage -t <pool_name> task_stat
    ...
    def query(self, query={}, decode=True):
        ...
        python -m my_qlib.workflow.task.manage -t <your task pool> query '{"_id": "615498be837d0053acbc5d58"}'
...
if __name__ == "__main__":
    ...
    # E.g. : `python -m my_qlib.workflow.task.manage list`
    auto_init()
