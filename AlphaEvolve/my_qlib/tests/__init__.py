...
from my_qlib.data.filter import NameDFilter
from my_qlib.data import D
from my_qlib.data.data import Cal, DatasetD
from my_qlib.data.storage import CalendarStorage, InstrumentStorage, FeatureStorage, CalVT, InstKT, InstVT


class TestAutoData(unittest.TestCase):
    _setup_kwargs = {}
    provider_uri = "~/.my_qlib/qlib_data/cn_data_simple"  # target_dir
    provider_uri_1day = "~/.my_qlib/qlib_data/cn_data"  # target_dir
    provider_uri_1min = "~/.my_qlib/qlib_data/cn_data_1min"
...
class TestMockData(unittest.TestCase):
    _setup_kwargs = {
        "calendar_provider": {
            ...
            "module_path": "my_qlib.data.data",
            "kwargs": {"backend": {"class": "MockCalendarStorage", "module_path": "my_qlib.tests"}},
        },
        "instrument_provider": {
            "class": "LocalInstrumentProvider",
            "module_path": "my_qlib.data.data",
            "kwargs": {"backend": {"class": "MockInstrumentStorage", "module_path": "my_qlib.tests"}},
        },
        "feature_provider": {
            "class": "LocalFeatureProvider",
            "module_path": "my_qlib.data.data",
            "kwargs": {"backend": {"class": "MockFeatureStorage", "module_path": "my_qlib.tests"}},
        },
    }
