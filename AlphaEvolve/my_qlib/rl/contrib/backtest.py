...
from my_qlib.backtest import INDICATOR_METRIC, collect_data_loop, get_strategy_executor
from my_qlib.backtest.decision import BaseTradeDecision, Order, OrderDir, TradeRangeByTime
from my_qlib.backtest.executor import SimulatorExecutor
from my_qlib.backtest.high_performance_ds import BaseOrderIndicator
from my_qlib.rl.contrib.naive_config_parser import get_backtest_config_fromfile
from my_qlib.rl.contrib.utils import read_order_file
from my_qlib.rl.data.integration import init_qlib
from my_qlib.rl.order_execution.simulator_qlib import SingleAssetOrderExecution
...
def _get_multi_level_executor_config(
    ...
    executor_config = {
        ...
        "module_path": "my_qlib.backtest.executor",
        "kwargs": {
...
def single_with_simulator(
    ...
    """
    init_qlib(backtest_config["my_qlib"])
...
def single_with_collect_data_loop(
    ...
    strategy_config = {
        ...
        "module_path": "my_qlib.contrib.strategy.rule_strategy",
        "kwargs": {
            "file": orders,
