...
from my_qlib.rl.simulator import InitialStateType
from my_qlib.rl.utils import EnvWrapper, FiniteEnvType, LogBuffer, LogCollector, LogLevel, LogWriter, vectorize_env
...
class Trainer:
    ...
    fast_dev_run
        ...
        For :class:`~my_qlib.rl.vessel.TrainingVessel`, if greater than zero,
