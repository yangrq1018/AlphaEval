...
This is the format used in `OPD paper <https://seqml.github.io/opd/>`__. NOT the standard data format in my_qlib.
...
This file shows resemblence to my_qlib.backtest.high_performance_ds. We might merge those two in future.
"""

# TODO: merge with my_qlib/backtest/high_performance_ds.py
...
from my_qlib.backtest.decision import Order, OrderDir
from my_qlib.rl.data.base import BaseIntradayBacktestData, BaseIntradayProcessedData, ProcessedDataProvider
