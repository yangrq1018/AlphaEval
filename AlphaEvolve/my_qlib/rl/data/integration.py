...
"""
TODO: This file is used to integrate NeuTrader with my_qlib to run the existing projects.
...
import my_qlib
from my_qlib.constant import REG_CN
from my_qlib.contrib.ops.high_freq import BFillNan, Cut, Date, DayCumsum, DayLast, FFillNan, IsInf, IsNull, Select
        ...
        calendar_provider={
            ...
            "kwargs": {
                "backend": {
                    ...
                    "module_path": "my_qlib.data.storage.file_storage",
