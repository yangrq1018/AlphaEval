...
# make import more user-friendly by adding `from my_qlib.backtest import STH`
...
def format_decisions(
    ...
    """
    format the decisions collected by `my_qlib.backtest.collect_data`
    The decisions will be organized into a tree-like structure.

    Parameters
    ----------
    decisions : List[BaseTradeDecision]
        decisions collected by `my_qlib.backtest.collect_data`
