...
def main(
    ...
    checkpoint_callback = CustomCallback(
        save_freq=10000,
        show_freq=10000,
        save_path='/data/home/dinghj/zr-alphagen/zr-alpha-training-base/paper/checkpoints',
    ...
    model = MaskablePPO(
        ...
        ent_coef=0.01,
        batch_size=128,
        tensorboard_log='/data/home/dinghj/zr-alphagen/zr-alpha-training-base/paper/test_log',
        device=device,
        verbose=1,
    )
    model.learn(
